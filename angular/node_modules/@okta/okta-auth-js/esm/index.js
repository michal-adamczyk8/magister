...
var OktaUserAgent = /*#__PURE__*/function () {
  function OktaUserAgent() {
    ...
    this.environments = ["okta-auth-js/".concat("5.9.0")];
  }
...
var OktaAuth = /*#__PURE__*/function () {
  function OktaAuth(args) {
    ...
    if (isBrowser()) {
      ...
      this.userAgent = getUserAgent(args, "okta-auth-js/".concat("5.9.0"));
    } else {
      this.userAgent = getUserAgent(args, "okta-auth-js-server/".concat("5.9.0"));
    }
