...
function DlDateTimePickerComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "div");
} }
function DlDateTimePickerComponent_div_8_div_1_Template(rf, ctx) { if (rf & 1) {
...
function DlDateTimePickerComponent_div_8_Template(rf, ctx) { if (rf & 1) {
...
function DlDateTimePickerComponent_div_9_div_1_Template(rf, ctx) { if (rf & 1) {
    const _r13 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 15);
    ɵngcc0.ɵɵlistener("click", function DlDateTimePickerComponent_div_9_div_1_Template_div_click_0_listener() { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r13); const cell_r11 = restoredCtx.$implicit; const ctx_r12 = ɵngcc0.ɵɵnextContext(2); return ctx_r12._onDateClick(cell_r11); })("keydown.space", function DlDateTimePickerComponent_div_9_div_1_Template_div_keydown_space_0_listener() { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r13); const cell_r11 = restoredCtx.$implicit; const ctx_r14 = ɵngcc0.ɵɵnextContext(2); return ctx_r14._onDateClick(cell_r11); })("keydown.enter", function DlDateTimePickerComponent_div_9_div_1_Template_div_keydown_enter_0_listener() { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r13); const cell_r11 = restoredCtx.$implicit; const ctx_r15 = ɵngcc0.ɵɵnextContext(2); return ctx_r15._onDateClick(cell_r11); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function DlDateTimePickerComponent_div_9_Template(rf, ctx) { if (rf & 1) {
...
function DlDateTimePickerComponent_ng_template_10_Template(rf, ctx) { if (rf & 1) {
...
function DlDateTimePickerComponent_ng_template_12_Template(rf, ctx) { if (rf & 1) {
    const _r17 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "button", 17);
    ɵngcc0.ɵɵlistener("click", function DlDateTimePickerComponent_ng_template_12_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r17); const ctx_r16 = ɵngcc0.ɵɵnextContext(); return ctx_r16._onUpClick(); });
    ɵngcc0.ɵɵtext(1);
...
DlDateAdapterMoment.ɵfac = /*@__PURE__*/ function () { let ɵDlDateAdapterMoment_BaseFactory; return function DlDateAdapterMoment_Factory(t) { return (ɵDlDateAdapterMoment_BaseFactory || (ɵDlDateAdapterMoment_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(DlDateAdapterMoment)))(t || DlDateAdapterMoment); }; }();
DlDateAdapterMoment.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DlDateAdapterMoment, factory: DlDateAdapterMoment.ɵfac });
...
DlDateAdapterNative.ɵfac = /*@__PURE__*/ function () { let ɵDlDateAdapterNative_BaseFactory; return function DlDateAdapterNative_Factory(t) { return (ɵDlDateAdapterNative_BaseFactory || (ɵDlDateAdapterNative_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(DlDateAdapterNative)))(t || DlDateAdapterNative); }; }();
DlDateAdapterNative.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DlDateAdapterNative, factory: DlDateAdapterNative.ɵfac });
...
DlDateAdapterNumber.ɵfac = /*@__PURE__*/ function () { let ɵDlDateAdapterNumber_BaseFactory; return function DlDateAdapterNumber_Factory(t) { return (ɵDlDateAdapterNumber_BaseFactory || (ɵDlDateAdapterNumber_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(DlDateAdapterNumber)))(t || DlDateAdapterNumber); }; }();
DlDateAdapterNumber.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DlDateAdapterNumber, factory: DlDateAdapterNumber.ɵfac });
...
DlDateAdapterString.ɵfac = function DlDateAdapterString_Factory(t) { return new (t || DlDateAdapterString)(ɵngcc0.ɵɵinject(DL_DATE_TIME_INPUT_FORMATS), ɵngcc0.ɵɵinject(DL_DATE_TIME_MODEL_FORMAT)); };
DlDateAdapterString.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DlDateAdapterString, factory: function (t) { return DlDateAdapterString.ɵfac(t); } });
...
DlDateTimeCoreModule.ɵfac = function DlDateTimeCoreModule_Factory(t) { return new (t || DlDateTimeCoreModule)(); };
DlDateTimeCoreModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: DlDateTimeCoreModule });
DlDateTimeCoreModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [
...
DlDateTimeNumberModule.ɵfac = function DlDateTimeNumberModule_Factory(t) { return new (t || DlDateTimeNumberModule)(); };
DlDateTimeNumberModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: DlDateTimeNumberModule });
DlDateTimeNumberModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [
...
DlDateTimeDateModule.ɵfac = function DlDateTimeDateModule_Factory(t) { return new (t || DlDateTimeDateModule)(); };
DlDateTimeDateModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: DlDateTimeDateModule });
DlDateTimeDateModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [
...
DlDateTimeMomentModule.ɵfac = function DlDateTimeMomentModule_Factory(t) { return new (t || DlDateTimeMomentModule)(); };
DlDateTimeMomentModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: DlDateTimeMomentModule });
DlDateTimeMomentModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [
...
DlDateTimeStringModule.ɵfac = function DlDateTimeStringModule_Factory(t) { return new (t || DlDateTimeStringModule)(); };
DlDateTimeStringModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: DlDateTimeStringModule });
DlDateTimeStringModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [
...
DlDateTimeInputDirective.ɵfac = function DlDateTimeInputDirective_Factory(t) { return new (t || DlDateTimeInputDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(DlDateAdapter), ɵngcc0.ɵɵdirectiveInject(DL_DATE_TIME_DISPLAY_FORMAT), ɵngcc0.ɵɵdirectiveInject(DL_DATE_TIME_INPUT_FORMATS)); };
DlDateTimeInputDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: DlDateTimeInputDirective, selectors: [["input", "dlDateTimeInput", ""]], hostBindings: function DlDateTimeInputDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("change", function DlDateTimeInputDirective_change_HostBindingHandler() { return ctx._onChange(); })("blur", function DlDateTimeInputDirective_blur_HostBindingHandler() { return ctx._onBlur(); })("input", function DlDateTimeInputDirective_input_HostBindingHandler($event) { return ctx._onInput($event.target.value); });
    } }, inputs: { dlDateTimeInputFilter: "dlDateTimeInputFilter" }, outputs: { dateChange: "dateChange" }, features: [ɵngcc0.ɵɵProvidersFeature([
...
DlDateTimeInputDirective = DlDateTimeInputDirective_1 = __decorate([ __param(3, Inject(DL_DATE_TIME_DISPLAY_FORMAT)),
...
DlDateTimeInputModule.ɵfac = function DlDateTimeInputModule_Factory(t) { return new (t || DlDateTimeInputModule)(); };
DlDateTimeInputModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: DlDateTimeInputModule });
DlDateTimeInputModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
...
DlDayModelProvider.ɵfac = function DlDayModelProvider_Factory(t) { return new (t || DlDayModelProvider)(); };
DlDayModelProvider.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DlDayModelProvider, factory: DlDayModelProvider.ɵfac });
...
DlHourModelProvider.ɵfac = function DlHourModelProvider_Factory(t) { return new (t || DlHourModelProvider)(); };
DlHourModelProvider.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DlHourModelProvider, factory: DlHourModelProvider.ɵfac });
...
DlMinuteModelProvider.ɵfac = function DlMinuteModelProvider_Factory(t) { return new (t || DlMinuteModelProvider)(); };
DlMinuteModelProvider.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DlMinuteModelProvider, factory: DlMinuteModelProvider.ɵfac });
...
DlMonthModelProvider.ɵfac = function DlMonthModelProvider_Factory(t) { return new (t || DlMonthModelProvider)(); };
DlMonthModelProvider.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DlMonthModelProvider, factory: DlMonthModelProvider.ɵfac });
...
DlYearModelProvider.ɵfac = function DlYearModelProvider_Factory(t) { return new (t || DlYearModelProvider)(); };
DlYearModelProvider.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DlYearModelProvider, factory: DlYearModelProvider.ɵfac });
...
DlDateTimePickerComponent.ɵfac = function DlDateTimePickerComponent_Factory(t) { return new (t || DlDateTimePickerComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(DlDateAdapter), ɵngcc0.ɵɵdirectiveInject(DlYearModelProvider), ɵngcc0.ɵɵdirectiveInject(DlMonthModelProvider), ɵngcc0.ɵɵdirectiveInject(DlDayModelProvider), ɵngcc0.ɵɵdirectiveInject(DlHourModelProvider), ɵngcc0.ɵɵdirectiveInject(DlMinuteModelProvider)); };
DlDateTimePickerComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: DlDateTimePickerComponent, selectors: [["dl-date-time-picker"]], inputs: { leftIconClass: "leftIconClass", maxView: "maxView", minView: "minView", minuteStep: "minuteStep", rightIconClass: "rightIconClass", selectFilter: "selectFilter", startView: "startView", upIconClass: "upIconClass", startDate: "startDate" }, outputs: { change: "change" }, features: [ɵngcc0.ɵɵProvidersFeature([
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: DlDateTimePickerComponent_1,
                multi: true
            }
        ]), ɵngcc0.ɵɵNgOnChangesFeature], decls: 14, vars: 17, consts: [[1, "row", "align-items-center", "no-gutters"], ["type", "button", 1, "col", "dl-abdtp-left-button", "align-items-center", 3, "click"], [1, "left-icon", 3, "ngClass"], [4, "ngIf", "ngIfThen", "ngIfElse"], ["type", "button", 1, "col", "dl-abdtp-right-button", 3, "click"], [1, "right-icon", 3, "ngClass"], [3, "keydown"], ["class", "row no-gutters", 4, "ngIf"], ["class", "row align-items-center no-gutters", 4, "ngFor", "ngForOf"], ["maxViewLabel", ""], ["defaultViewLabel", ""], [1, "row", "no-gutters"], ["class", "col align-items-center no-gutters dl-abdtp-col-label", 4, "ngFor", "ngForOf"], [1, "col", "align-items-center", "no-gutters", "dl-abdtp-col-label"], ["role", "gridcell", 3, "class", "ngClass", "click", "keydown.space", "keydown.enter", 4, "ngFor", "ngForOf"], ["role", "gridcell", 3, "ngClass", "click", "keydown.space", "keydown.enter"], [1, "col-10", "dl-abdtp-view-label"], ["type", "button", 1, "col-10", "dl-abdtp-view-label", "dl-abdtp-up-button", 3, "ngClass", "click"], [1, "up-icon", 3, "ngClass"]], template: function DlDateTimePickerComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "div");
        ɵngcc0.ɵɵelementStart(1, "div", 0);
        ɵngcc0.ɵɵelementStart(2, "button", 1);
        ɵngcc0.ɵɵlistener("click", function DlDateTimePickerComponent_Template_button_click_2_listener() { return ctx._onLeftClick(); });
        ...
        ɵngcc0.ɵɵlistener("click", function DlDateTimePickerComponent_Template_button_click_5_listener() { return ctx._onRightClick(); });
        ɵngcc0.ɵɵelement(6, "span", 5);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementStart(7, "div", 6);
        ɵngcc0.ɵɵlistener("keydown", function DlDateTimePickerComponent_Template_div_keydown_7_listener($event) { return ctx._handleKeyDown($event); });
...
DlDateTimePickerModule.ɵfac = function DlDateTimePickerModule_Factory(t) { return new (t || DlDateTimePickerModule)(); };
DlDateTimePickerModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: DlDateTimePickerModule });
DlDateTimePickerModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [
        DlYearModelProvider,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DlDateTimeCoreModule, [{
        type: NgModule,
        args: [{
                providers: [
                    { provide: DL_DATE_TIME_DISPLAY_FORMAT, useValue: ɵ0 },
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DlDateTimeNumberModule, [{
        type: NgModule,
        args: [{
                imports: [DlDateTimeCoreModule],
                providers: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DlDateTimeNumberModule, { imports: [DlDateTimeCoreModule], exports: [DlDateTimeCoreModule] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DlDateTimeDateModule, [{
        type: NgModule,
        args: [{
                imports: [DlDateTimeCoreModule],
                providers: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DlDateTimeDateModule, { imports: [DlDateTimeCoreModule] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DlDateTimeMomentModule, [{
        type: NgModule,
        args: [{
                imports: [DlDateTimeCoreModule],
                providers: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DlDateTimeMomentModule, { imports: [DlDateTimeCoreModule] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DlDateTimeStringModule, [{
        type: NgModule,
        args: [{
                imports: [DlDateTimeCoreModule],
                providers: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DlDateTimeStringModule, { imports: [DlDateTimeCoreModule] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DlDateTimeInputDirective, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.Renderer2 }, { type: ɵngcc0.ElementRef }, { type: DlDateAdapter }, { type: String, decorators: [{
                type: Inject,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DlDateTimeInputModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DlDateTimeInputModule, { declarations: function () { return [DlDateTimeInputDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [DlDateTimeInputDirective]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DlDateTimePickerComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.NgZone }, { type: DlDateAdapter }, { type: DlYearModelProvider }, { type: DlMonthModelProvider }, { type: DlDayModelProvider }, { type: DlHourModelProvider }, { type: DlMinuteModelProvider }]; }, { change: [{
            type: Output
        }], leftIconClass: [{
            type: Input
        }], maxView: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DlDateTimePickerModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DlDateTimePickerModule, { declarations: function () { return [DlDateTimePickerComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [DlDateTimePickerComponent]; } }); })();
